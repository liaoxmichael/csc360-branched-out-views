...
public class BranchedOutModel
{
	...
	public TestJobPostingModel toiletFlusher = new TestJobPostingModel("Toilet Flusher",
	...
	public TestJobPostingModel unflusher = new TestJobPostingModel("Toilet Unflusher", "You know what to do.",
			"Centre College", "Danville, KY", "Remote", 22, "05-13-2023", "Big Heart", "React.js",
			"ChatGPT proficiency");
	public TestJobPostingModel supportAnimal = new TestJobPostingModel("Support Animal", "For student mental health.",
